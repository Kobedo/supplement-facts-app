  ...
  <div class="bg-white p-4 rounded shadow">
    ...
    <div class="mb-4">
      ...
      <div class="grid grid-cols-2 gap-2">
        <input bind:value={dailyValueSymbol} placeholder="Daily Value Symbol" class="p-2 border rounded" />
        <input bind:value={nonDailyValueSymbol} placeholder="Non-Daily Value Symbol" class="p-2 border rounded" />
